...
with st.container():
    ...
    st.write("\n")
    st.write("In conclusion, our exploration into New York's artistic community has revealed a multifaceted landscape, rich in diversity and creativity. The dominance of visual arts, music, film, and media arts underscores the city's dynamic cultural fabric. The challenges faced by artists, especially during the pandemic, highlight the resilience required in pursuing their passions. CRNY's Guaranteed Income Program emerges as a beacon of support, showcasing the potential for positive change within the artistic community. As we envision a sustainable future for the arts, the data visualizations underscore the need for continued advocacy, policy support, and holistic well-being initiatives. New York's artists, with their varied practices and backgrounds, collectively contribute to a thriving cultural ecosystem that shapes the city's identity and fosters a sense of unity amid diversity.")
